...
extern char BatteryPecentBuf[16*4];   
...
extern void HalLcdShowString(uint8 x,uint8 y,char *chr,uint8 font_size);
extern void HalLcdDrawBattery(uint8 x,uint8 y,uint16 pecent);
extern void HalLcdDrawBt(uint8 x,uint8 y,uint8 flag);

extern unsigned char* IntToStr(unsigned char* buf, int m);
extern void LCD_CLS(void);
//void LCD_DisplayOn(void);
extern void HalLcdClear(void);
extern void HalLcdDisOff(void);
extern void HalLcdDisOn(void);
extern void HalLcdDisLogo(void);
